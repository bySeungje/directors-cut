...
const BANK: Record<number, Directive[]> = {
  ...
  5: [
    { composition: [{ type: 'chaser', count: 18, spawn: 'RING', elite: false }, { type: 'splitter', count: 8, spawn: 'PINCER', elite: false }], mutation: 'SPAWN_STORM', buff: 'NONE', deny: 'NONE', taunt: '끝없이 몰아친다. 버텨봐라.', intent: '지속 압박' },
  ...
  6: [
    ...
    { composition: [{ type: 'chaser', count: 25, spawn: 'N', elite: false }, { type: 'chaser', count: 25, spawn: 'S', elite: false }, { type: 'chaser', count: 2, spawn: 'RING', elite: true }], mutation: 'SPAWN_STORM', buff: 'NONE', deny: 'NONE', taunt: '최정예다. 물러설 곳도 없다.', intent: '엘리트 물량' },
  ],
  7: [
    ...
    { composition: [{ type: 'splitter', count: 21, spawn: 'PINCER', elite: false }, { type: 'splitter', count: 21, spawn: 'RING', elite: false }], mutation: 'SPAWN_STORM', buff: 'NONE', deny: 'NONE', taunt: '이것이 나의 연출이다.', intent: '피날레: 분열 폭풍' },
    { composition: [{ type: 'shooter', count: 6, spawn: 'RING', elite: true }, { type: 'chaser', count: 25, spawn: 'BEHIND', elite: false }, { type: 'chaser', count: 25, spawn: 'N', elite: false }], mutation: 'FOG', buff: 'NONE', deny: 'NONE', taunt: '엔딩은 어둠 속에서.', intent: '피날레: 암전 총공세' },
  ],
};
